				...
				<div class="col-sm-6 col-lg-4 col-xl-3">
					<div class="single-person">
						<div class="person-image">
							<img src="https://static.independent.co.uk/s3fs-public/thumbnails/image/2014/01/14/12/monkey-bananav3.jpg" alt="">
						</div>
						<div class="person-info">
							<h3 class="full-name">Saher khalaf</h3>
							<span class="speciality">wa7d haewan</span>
						</div>
					</div>
				</div>
				<!-- / End Single Person -->
